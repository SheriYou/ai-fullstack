...
| **完整用例** | `data/test-cases-full.csv`（本文） | 冒烟/链路/字段/日志/指标；人工+L1/L3 执行 |
...
| ID | 标题 | 类型 | 步骤/输入 | 预期 | 层 | 执行 |
|----|------|------|-----------|------|-----|------|
| TC-M4-P1-001 | 不编造 | faq_rule | 1. 发消息/FAQ 无覆盖问题 | 兜底+转人工；不编造 | L2/L3 | both |
| TC-M4-P1-002 | 动态信息转人工 | faq_rule | 1. 发消息/还有库存吗 | 转人工；不硬答 | L2/L3 | both |
| TC-M4-P1-003 | 动态信息转人工2 | faq_rule | 1. 发消息/我的订单到哪了 | 转人工 | L2/L3 | both |
